options(scipen=999)
project_directory <- "/lustre/scratch/jmanthey/05_certhia_hybrids/07_window_stats"
directory_name <- "22_certhia_stats"
cluster <- "nocona"
max_number_jobs <- 60
...
vcf_header <- paste0(project_directory, "/Ca_0028_Tg_23.recode.vcf.gz")
